...
import "github.com/limyel/base/tree/btree"
...
func equal(a, b btree.Item) bool {
...
func (n *Node) search(item btree.Item) int {
	i := 0
...
func (bt *BTree) search(n *Node, item btree.Item) (*Node, int) {
	i := n.search(item)
...
func (bt *BTree) insert(item btree.Item) {
	if bt.root == nil {
